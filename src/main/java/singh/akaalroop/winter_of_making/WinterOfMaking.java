        ...
        CommandRegistrationCallback.EVENT.register((dispatcher, registryAccess, environment) -> dispatcher.register(CommandManager.literal("wom-shop")
                .executes(context -> {
                    context.getSource().sendFeedback(() -> Text.literal("The available Winter of Making shop items are: \n").formatted(Formatting.AQUA)
                            ...
                            .append(Text.literal("8. SNOW BOMB! (Spawn 10 snowballs 2 blocks behind everyone's back flying towards them!) - 1000 snowflakes!").formatted(Formatting.BOLD).formatted(Formatting.GOLD).append(Text.literal(" (Beta - May not work for all players) \n").formatted(Formatting.RED))), false);
                    return 1;
                })
